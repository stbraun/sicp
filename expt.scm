...
(module expt racket
        ...
        (module+ test
                 (check-equal? (expt 2 5) (fast-expt-r 2 5))
                 (check-equal? (expt 3 4) (fast-expt-r 3 4))
                 (check-equal? (expt 7 13) (fast-expt-r 7 13)))
        ...
        (module+ test
                 (check-equal? (expt 2 5) (fast-expt-i 2 5))
                 (check-equal? (expt 3 4) (fast-expt-i 3 4))
                 (check-equal? (expt 7 13) (fast-expt-i 7 13)))
        )
